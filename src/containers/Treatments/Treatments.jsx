      ...
      <Row>
        <Col className="d-flex col-12 flex-wrap justify-content-center">
          <Card className="cardStyle m-4" style={{ width: "18rem" }}>
            ...
            <Card.Body>
              <Card.Title href="/endodoncia">Endodoncia</Card.Title>
          ...
          <Card className=" cardStyle m-3 " style={{ width: "17rem" }}>
            ...
            <Card.Body>
              <Card.Title className="" href="/estetica">
                Estética Dental
              </Card.Title>
              <Card.Text className="textDesign ">
          ...
          <Card style={{ width: "18rem" }} className="cardStyle m-3">
            ...
            <Card.Body>
              <Card.Title href="/implantes">Implantes</Card.Title>
              <Card.Text>
      ...
      <Row>
        <Col className="d-flex col-12 flex-wrap  justify-content-center">
          <Card style={{ width: "18rem" }} className="cardStyle m-3">
            ...
            <Card.Body>
              <Card.Title href="/odontopediatria">Odontopediatría</Card.Title>
              <Card.Text>
          ...
          <Card style={{ width: "18rem" }} className="cardStyle m-3">
            ...
            <Card.Body>
              <Card.Title href="/ortodoncia">Ortodoncia</Card.Title>
              <Card.Text>
          ...
          <Card style={{ width: "18rem" }} className="cardStyle m-3">
            ...
            <Card.Body>
              <Card.Title href="/invisalign">Ortodoncia Invisible</Card.Title>
              <Card.Text>
      ...
      <Row>
        <Col className="d-flex col-12 flex-wrap  justify-content-center">
          <Card style={{ width: "18rem" }} className="cardStyle m-3">
            ...
            <Card.Body>
              <Card.Title href="/periodoncia">Periodoncia</Card.Title>
          ...
          <Card style={{ width: "18rem" }} className="cardStyle m-3">
            ...
            <Card.Body>
              <Card.Title href="/protesis">Protesis</Card.Title>
              <Card.Text>
