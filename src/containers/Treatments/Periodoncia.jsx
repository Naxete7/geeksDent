    ...
    <Container fluid className="treatmentsDesign">
      <Row>
        <Col>
          ...
          <h6>Gingivitis</h6>
          <p>
            La gingivitis provoca la inflamación de las encías y su sangrado. Se
            produce porque las encías se llenan de bacterias. La gingivitis,
            bien tratada, no reviste especial gravedad a diferencia de la
            periodontitis. No obstante, es un primer signo de alarma ante el
            cual hay que tomar medidas de inmediato para que no se agrave.
          </p>
        </Col>
      </Row>
      ...
      <Row>
        <Col>
          ...
          <p>
            ...
            periodonto. La solución es complicada y es posible que el diente se
            caiga o se parta. Por lo tanto, la atención debe ser urgente y el
            tratamiento ha de seguirse estrictamente según la prescripción
            médica. En casos graves, la presencia de piorrea no solo afecta a la
            estética y funcionalidad de la boca, sino que puede derivar en
      ...
      <Row>
        <Col>
          ...
          <p>
            ...
            cicatrización de los tejidos. Puede ser un factor etiológico directo
            en la progresión de una lesión estable de gingivitis a una
            ...
            tiene un papel importante en la susceptibilidad a la periodontitis.
            El riesgo de pérdida dental es significativamente alto si se combina
            con el consumo de tabaco. Seguir una inadecuada higiene oral es otro
            de los factores de riesgo más extendidos. El apiñamiento dental y
            otros problemas de malposición dentaria pueden dificultar la
            realización de una completa limpieza oral diaria, provocando un alto
            riesgo de padecer patologías periodontales.
          </p>
          ...
          <p>
            ...
            inflamación gingival provocada por placa bacteriana preexistente. La
            gingivitis del embarazo es muy común y afecta a entre un 60-75% de
            las mujeres embarazadas. Los signos de la enfermedad comienzan
            durante el segundo mes de gestación y alcanzan su pico máximo en el
            octavo mes.
          </p>
        </Col>
      </Row>
      ...
      <Row>
        <Col>
          ...
          <p>
            ...
            mediante una profilaxis profesional. En el caso de la periodontitis,
            el tratamiento suele organizarse en dos fases. En la fase básica se
            eliminan las bacterias periodontales mediante el raspado y alisado
            radicular. En enfermedades cuyo estado es más grave se considerará
            acceder a las bolsas periodontales profundas realizando una cirugía
            periodontal. A veces, en este tipo de fases se aplican técnicas de
            regeneración ósea. Si las encías están muy retraídas puede llevarse
            a cabo una cirugía periodontal con injertos para cubrir la parte que
            se ha perdido tras su deterioro. Es muy importante concienciar a los
            pacientes sobre las consecuencias que tiene la enfermedad
            periodontal para que adquieran hábitos de higiene oral adecuados y
            puedan prevenir que la afección periodontal vuelva a manifestarse.
          </p>
        </Col>
      </Row>
    </Container>
