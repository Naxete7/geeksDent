    ...
    <Container fluid className="treatmentsDesign">
      ...
      <Row className=" d-flex flex-wrap justify-content-center">
        <Col className="col-8">
          ...
          <p>
            Las obturaciones, comúnmente conocidas como empastes dentales, es el
            tratamiento que se realiza a los pacientes afectados por caries u
            otras enfermedades que generan una cavidad. Con la obturación se
            consigue reparar y restaurar la anatomía y función del diente.
          </p>
          <h5>Traumatismos y fracturas</h5>
          <p>
            Los traumatismos dentales y las fracturas son bastante habituales en
            los niños debido a las caídas y golpes que sufren al ser pequeños.
            Es importante acudir al dentista para restaurar el diente, de manera
            que no afecte la estética ni la funcionalidad de la mordida del
            niño.
          </p>
        </Col>
      </Row>
      ...
      <Row>
        ...
        <p>
          ...
          necesario hacer un tratamiento de pulpotomía o pulpectomía, los cuales
          consisten en la remoción de una parte de la pulpa del diente de leche
          para eliminar todo rastro de infección, restaurar el espacio con
          sellador y evitar cualquier inflamación y dolor.
        </p>
      </Row>
      <Row className=" d-flex flex-wrap justify-content-center">
        <Col className="col-8">
      ...
      <Row>
        ...
        <p>
          Uno de los tratamientos preventivos más populares es la aplicación de
          flúor, el cual funciona para restaurar la resistencia de las capas
          superiores del diente y evitar la aparición de infecciones y caries.
          Este procedimiento es completamente indoloro y puede ser llevado a
          cabo por medio de geles, barniz o espuma. Si quieres acudir GeeksDent
          para que le realicemos una revisión bucodental a tu hijo o hija, no
          dudes en ponerte en contacto con nosotros. La prevención es
          fundamental para que los más pequeños tengan unos dientes sanos y su
          desarrollo sea el correcto hasta llegar a la edad adulta.
        </p>
      </Row>
    </Container>
  );
