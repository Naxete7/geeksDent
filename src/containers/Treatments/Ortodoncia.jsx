  ...
  return (
    <Container fluid className="treatmentsDesign">
      <Row>
        <Col>
          ...
          <p>
            ...
            grande diremos que es de origen dental cuando los dientes superiores
            muy adelantados y siempre y cuando tanto maxilar como mandíbula sean
            de un tamaño normal.
          </p>{" "}
          <h5> · Clase III</h5>
          <p>
            Es cuando el paciente tiene la mandíbula muy grande o un maxilar
            pequeño diremos que el origen es dental cuando los dientes de abajo
            se sitúen por delante de los dientes de arriba siempre y cuando
            tanto maxilar como mandíbula sean de un tamaño normal. · Mordida
            abierta Se suele producir por el uso del chupete en niños mayores a
            dos años, o por la presencia de algún mal hábito como puede ser
            chuparse el dedo o la deglución atípica (cuando al tragar se pone la
            lengua entre los dientes anteriores)
          </p>{" "}
          <h5>· Sobremordida o mordida profunda</h5>
          <p>
            Cuando los incisivos superiores tapan completamente a los incisivos
            inferiores.
          </p>
          <h5>· Mordida cruzada</h5>
          <p>
            Cuando el paladar es mas estrecho que la mandíbula por lo que se
            puede apreciar como los molares superiores muerden por dentro de los
            molares inferiores
          </p>{" "}
          <h5>· Apiñamiento</h5>
          <p>
            Amontonamiento de los dientes que se produce generalmente por falta
            de espacio. Estos problemas pueden darse por separado o de manera
            conjunta algunos de ellos.
          </p>
        </Col>
      </Row>
      <br></br>
      ...
      <Row>
        <Col>
          ...
          <p>
            ...
            crecimiento de los huesos maxilares para un desarrollo y crecimiento
            equilibrado de las estructuras que componen la boca. Al fin y al
            cabo, lo que se busca con este tipo de tratamientos es corregir la
            bases donde van a ir alojados los dientes y haya un desarrollo
            correcto de la función oral.
          </p>
        </Col>
      </Row>
      <br></br>
      ...
      <Row>
        ...
        <p>
          Cuando hablamos de brackets nos estamos refiriendo aun tipo de aparato
          que se utiliza en ortodoncia para tratar la mal posición de los
          dientes. El bracket sirve como punto de apoyo para aplicar las fuerzas
          necesarias par que se produzca el movimiento del diente, unidos a los
          arcos de ortodoncia servirán para resolver los distinto problemas
          maloclusivos o de mala oclusión que presenta el paciente.
        </p>
      ...
      <Row>
        <Col>
          ...
          <p>
            ...
            van pegados por la cara interna del diente por lo que no se ven. En
            la ortodoncia lingual la fuerza del bracket la ejerce desde la cara
            interna del diente por lo que son prácticamente invisibles
          </p>
          ...
          <p>
            ...
            digital ya que la planificación del caso se realiza por ordenador, a
            partir de unos modelos digitales de la boca del paciente. Una vez el
            doctor realiza su plan de tratamiento digital puede mostrar al
            paciente mediante la simulación digital qué movimientos se van a
            realizar en sis dientes y como va a ser el aproximadamente el
            resultado. Los alineadores al ser una ortodoncia digital mueven los
            dientes de manera mas efectiva acortando en muchos casos el tiempo
            de tratamiento de la ortodoncia convencional o analógica. En la
            Clínica Dental Dr. Peset trabajamos con lo alineadores de
